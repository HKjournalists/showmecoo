...
/**
 * 主持人 业务层对象， 对应新增主持人页面参数
 *
 * @author weixin (mailto:weixin@showmecoo.com)
 */

public class CompereModel extends ActorModel {

	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = -4209964128405313527L;
	...
	public String toString() {
		return "CompereModel [skilledStyle=" + skilledStyle + ", displayAddr=" + displayAddr + ", displayPrice="
