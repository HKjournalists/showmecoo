...
public class ModelModel extends ActorModel {

	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 3249109791671448309L;
	
	private String skilledStyle;//模特的一级页面暂时按照男模和女模来区分
	...
	public String toString() {
		return "ModelModel [skilledStyle=" + skilledStyle + ", displayAddr=" + displayAddr + ", displayPrice="
