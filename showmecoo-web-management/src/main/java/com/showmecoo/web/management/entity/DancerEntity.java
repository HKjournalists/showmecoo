 ...
 */
@Entity
@Table(name="actor_dancer")
public class DancerEntity implements Serializable{

	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 7593693947687067028L;
...
//    @GenericGenerator(name="system-uuid",strategy="uuid")  
	...
	public String toString() {
		return "DancerEntity [actorId=" + actorId + ", skilledStyle=" + skilledStyle + ", displayAddr=" + displayAddr
