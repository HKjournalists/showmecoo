...
@Entity
@Table(name="actor_model")
public class ModelEntity implements Serializable{

	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 4134802655326777348L;
...
//    @GenericGenerator(name="system-uuid",strategy="uuid")  
	...
	public String toString() {
		return "ModelEntity [actorId=" + actorId + ", skilledStyle=" + skilledStyle + ", displayAddr=" + displayAddr
