 ...
 */
@Entity
@Table(name="work_picture")
public class PictureWorkEntity implements Serializable{
	
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 6116802842128813344L;
	...
	public String toString() {
		return "WorkPictureEntity [pictureId=" + pictureId + ", actorId=" + actorId + ", workName=" + workName
