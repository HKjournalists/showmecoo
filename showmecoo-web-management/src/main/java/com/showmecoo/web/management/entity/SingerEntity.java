 ...
 */
@Entity
@Table(name="actor_singer")
public class SingerEntity implements Serializable{

	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1101358893685904324L;
...
//    @GenericGenerator(name="system-uuid",strategy="uuid")  
	...
	public String toString() {
		return "SingerEntity [actorId=" + actorId + ", skilledStyle=" + skilledStyle + ", displayAddr=" + displayAddr
				+ ", displayPrice=" + displayPrice + ", represantiveWork=" + represantiveWork + ", standardDisplay="
				+ standardDisplay + ", mainImageName=" + mainImageName + ", secondImageName=" + secondImageName
				+ ", briefIntroduction=" + briefIntroduction + ", levelScore=" + levelScore + "]";
	}
